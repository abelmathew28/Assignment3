...
CARD_NAMES = {'Client1': 'Hearts', 'Client2':'Diamonds', 'Client3' : 'Clubs', 'Server' : 'Spades'}
...
try:
    ...
    for round_num in range(NUM_ROUNDS):
        ...
        for i, client_socket in enumerate(client_sockets):
            ...
            while True:
                ...
                print(card[0] + " played card : " + CARD_VALUES[int(card[1])])
                round_card[card[0]] = int(card[1])
                break
    ...
    winner_message = '******* Game Over! Winner is ' + max_score[0]+' *******'
